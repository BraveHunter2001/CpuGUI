...
{
    internal class SBB : CommandFormatRDSS
    {
        public SBB(int rd, int regLeft, int regRight) : base(rd, regLeft, regRight, 50)
        {
        }
        ...
        public override void Execute(Registers registers)
        {
            ...
            try
            {
                answer = checked(registers.Integer[registerSource] -
